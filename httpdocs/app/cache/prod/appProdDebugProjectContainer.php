...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'login_handler' => 'getLoginHandlerService',
            ...
            'propel.security.acl.connection' => 'getPropel_Security_Acl_ConnectionService',
            ...
            'security.user.provider.concrete.bower_user' => 'getSecurity_User_Provider_Concrete_BowerUserService',
    ...
    /**
     * Gets the 'login_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Nestle\CoreBundle\AuthenticationHandler\LoginHandler A Nestle\CoreBundle\AuthenticationHandler\LoginHandler instance.
     */
    protected function getLoginHandlerService()
    {
        return $this->services['login_handler'] = new \Nestle\CoreBundle\AuthenticationHandler\LoginHandler($this->get('router'), $this->get('security.context'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Nestle\CoreBundle\AuthenticationHandler\LogoutHandler A Nestle\CoreBundle\AuthenticationHandler\LogoutHandler instance.
     */
    protected function getLogoutHandlerService()
    {
        return $this->services['logout_handler'] = new \Nestle\CoreBundle\AuthenticationHandler\LogoutHandler($this->get('router'), $this->get('security.context'));
    }
    ...
    {
        return $this->services['propel.configuration'] = new \PropelConfiguration(array('datasources' => array('default' => array('adapter' => 'mysql', 'connection' => array('dsn' => 'mysql:host=localhost;dbname=nestlebower;charset=UTF8', 'user' => 'root', 'password' => 'root', 'classname' => 'DebugPDO', 'options' => array(), 'attributes' => array(), 'settings' => array(), 'model_paths' => array(0 => 'src/', 1 => 'vendor/'))))));
    }
    ...
    /**
     * Gets the 'propel.security.acl.connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PropelPDO A PropelPDO instance.
     */
    protected function getPropel_Security_Acl_ConnectionService()
    {
        return $this->services['propel.security.acl.connection'] = \Propel::getConnection('acl');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => false, 2 => 1)), 'Nestle\\CoreBundle\\Model\\NestleUsers' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.mobile' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/mobile$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/error404');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/error403');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/mobile');
        ...
        $l->add($k, array(0 => 'ROLE_ANALYST'), NULL);

        $m = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, $this->get('logout_handler'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.bower_user')), 'secured_area', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $m, 'secured_area', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('login_handler'), array('login_path' => 'login', 'default_target_path' => '/', 'use_referer' => true, 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'), 'secured_area'), $o, array('check_path' => '_security_check', 'use_forward' => true, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57a33ac87c59d5.48050311', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $m, 'login', true), 'error403', NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('dexter.loor@gmail.com');
        $a->setPassword('rocketman88');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/propel/propel-bundle/Propel/PropelBundle/Resources/views'), 'Propel');
        $instance->addPath(($this->targetDirs[3].'/src/Nestle/MobileBundle/Resources/views'), 'NestleMobile');
        $instance->addPath(($this->targetDirs[3].'/src/Nestle/CoreBundle/Resources/views'), 'NestleCore');
        $instance->addPath(($this->targetDirs[3].'/src/Nestle/WebBundle/Resources/views'), 'NestleWeb');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ANALYST' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_ANALYST', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }

    /**
     * Gets the 'security.user.provider.concrete.bower_user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_BowerUserService()
    {
        return $this->services['security.user.provider.concrete.bower_user'] = new \Symfony\Bridge\Propel1\Security\User\PropelUserProvider('Nestle\\CoreBundle\\Model\\NestleUsers', 'username');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.chain_provider'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('security.user.provider.concrete.bower_user')));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('superadmin', '9e54894425aee8a4e5c22a760358807534409594cf99bf4cc988735634cf0decb9f7bb4200d58d16c286ad1b82afd716e64d32578fa93848e8e000a1d126dab8', array(0 => 'ROLE_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NestleMobileBundle' => 'Nestle\\MobileBundle\\NestleMobileBundle',
                'NestleCoreBundle' => 'Nestle\\CoreBundle\\NestleCoreBundle',
                'NestleWebBundle' => 'Nestle\\WebBundle\\NestleWebBundle',
            ),
            ...
            'database_name' => 'nestlebower',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'dexter.loor@gmail.com',
            'mailer_password' => 'rocketman88',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'dexter.loor@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'rocketman88',
            ...
            'propel.path' => ($this->targetDirs[2].'/../vendor/propel/propel1'),
            'propel.phing_path' => ($this->targetDirs[2].'/../vendor/phing/phing/classes'),
            'propel.logging' => true,
