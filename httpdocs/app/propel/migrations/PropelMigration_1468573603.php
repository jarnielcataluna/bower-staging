 ...
 * up to version 1468573603.
 * Generated on 2016-07-15 17:06:43 by Propelrr-AJ
 */
class PropelMigration_1468573603
{
...
ALTER TABLE `promos` CHANGE `region_id` `region_id` INTEGER(1) DEFAULT 0;
...
ALTER TABLE `promos` CHANGE `region_id` `region_id` INTEGER(1);
